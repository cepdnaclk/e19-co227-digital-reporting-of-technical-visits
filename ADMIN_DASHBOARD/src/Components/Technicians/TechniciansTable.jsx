    ...
    <table className="tech-table">
      <thead>
        <tr>
          ...
          <th>Name <button onClick={()=>handleSort("firstName")}>^</button></th>
          <th>Email <button onClick={()=>handleSort("email")}>^</button></th>
          <th>Address <button onClick={()=>handleSort("address")}>^</button></th>
          <th>Telephone </th>
        </tr>
      </thead>
      <tbody>
